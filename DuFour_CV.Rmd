...
jobtitle: Research Fisheries Biologist
keywords: R Markdown, academic CV, template
linkcolor: blue
fontfamily: mathpazo
phone: (440) 813-2546
address: USGS Great Lakes Science Center - Lake Erie Biological Station
github: mrdufour
urlcolor: blue
---
...
Evans, T.M., Rudstam, L.G., Sethi, S.A., Yule, D.L., Hanson, S.D., Turschak, B., Warner, D.M., Farha, S.A., O'Brien, T.P., McDonnell, K.N., Watkins, J.M., **DuFour, M.R.**, Barnard, A.R., Wells, S.E., Koproski, S.R., Dieter, P.M., Kocher, E., Roberts, J.J., Swain, J.D., and Esselman, P.C. March 2023 (poster). *Assessing fish avoidance to motorized acoustic survey vessels using quiet autonomous Saildrones in the Great Lakes.* ICES  Fisheries and Plankton Acoustics Symposium, Portland, ME.
